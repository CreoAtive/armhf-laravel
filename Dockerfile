FROM bernhardesperester/armhf-apache-php
MAINTAINER Bernhard Esperester <bernhard@esperester.de>

RUN apt-get update && apt-get -y install git curl php5-mcrypt php5-json php5-gd imagemagick php5-imagick && apt-get -y autoremove && apt-get clean && rm -rf /var/lib/apt/lists/*
